...
export interface IHyperswapRouter01Interface extends utils.Interface {
  functions: {
...
export interface IHyperswapRouter01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IHyperswapRouter01Interface;
